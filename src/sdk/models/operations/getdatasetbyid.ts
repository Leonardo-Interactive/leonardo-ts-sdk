...
/** @internal */
export const DatasetImages$inboundSchema: z.ZodType<DatasetImages, z.ZodTypeDef, unknown> =
    z.object({
...
> = z
    .object({
        datasets_by_pk: z.nullable(z.lazy(() => GetDatasetByIdDatasets$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        datasetsByPk: z.nullable(z.lazy(() => GetDatasetByIdDatasets$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
