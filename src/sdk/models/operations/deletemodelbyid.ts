...
/** @internal */
export const CustomModels$inboundSchema: z.ZodType<CustomModels, z.ZodTypeDef, unknown> = z.object({
...
> = z
    .object({
        delete_custom_models_by_pk: z.nullable(z.lazy(() => CustomModels$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        deleteCustomModelsByPk: z.nullable(z.lazy(() => CustomModels$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
