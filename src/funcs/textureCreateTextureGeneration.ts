...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.CreateTextureGenerationRequestBody$outboundSchema.optional().parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.json(200, operations.CreateTextureGenerationResponse$inboundSchema, { key: "object" }))(
        response,
