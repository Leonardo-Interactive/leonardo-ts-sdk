...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.CreateSVDMotionGenerationRequestBody$outboundSchema.optional().parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.json(200, operations.CreateSVDMotionGenerationResponse$inboundSchema, { key: "object" }))(
        response,
