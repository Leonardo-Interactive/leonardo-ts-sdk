 ...
 */
export async function datasetCreateDataset(
  client$: LeonardoCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.CreateDatasetRequestBody$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.CreateDatasetResponse$inboundSchema, {
      key: "object",
    }),
