 ...
 */
export async function datasetDeleteDatasetById(
  client$: LeonardoCore,
  id: string,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.DeleteDatasetByIdRequest$outboundSchema.parse(value$),
  ...
  const path$ = pathToFunc("/datasets/{id}")(pathParams$);
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.DeleteDatasetByIdResponse$inboundSchema, {
      key: "object",
    }),
