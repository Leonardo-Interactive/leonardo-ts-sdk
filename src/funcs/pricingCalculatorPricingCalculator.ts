...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.PricingCalculatorRequestBody$outboundSchema.optional().parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.json(200, operations.PricingCalculatorResponse$inboundSchema, { key: "object" }))(
        response,
