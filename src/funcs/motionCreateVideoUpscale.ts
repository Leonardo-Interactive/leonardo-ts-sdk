 ...
 */
export function motionCreateVideoUpscale(
  client: LeonardoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateVideoUpscaleRequestBody$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/generations-video-upscale")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateVideoUpscaleResponse$inboundSchema, {
      key: "object",
    }),
