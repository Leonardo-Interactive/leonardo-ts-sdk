...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) =>
            operations.PerformAlchemyUpscaleLCMRequestBody$outboundSchema.optional().parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.json(200, operations.PerformAlchemyUpscaleLCMResponse$inboundSchema, { key: "object" }))(
        response,
