 ...
 */
export function blueprintsGetBlueprintExecutionGenerations(
  client: LeonardoCore,
  id: string | null,
...
> {
  const input: operations.GetBlueprintExecutionGenerationsRequest = {
    id: id,
    after: after,
    before: before,
    first: first,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetBlueprintExecutionGenerationsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.GetBlueprintExecutionGenerationsResponse$inboundSchema,
      { key: "object" },
    ),
